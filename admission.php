    ...
    <div class="container mt-5 mb-5">
        <div class="row">
            <div class="col-12 body-card">
                <h5 class="pt-2">Perosnal Details</h5><hr>
                <form>
                    <div class="row">
                ...
                <h5 class=pt-2>Institutional Informations</h5><hr>
                <div class="row">
                    <div class="col-md-4 col-sm-12">
                ...
                <div class="row">
                  ...
                  <h5 class="pt-2">Qualification</h5><hr>
                ...
                <h5 class="pt-2">Upload the Documents</h5><hr>
                <div class="row">
                    <div class="col-md-4 col-sm-12">
